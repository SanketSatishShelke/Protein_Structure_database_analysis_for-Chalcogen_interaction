...
def phi_conversion(φ1):
    """
    Converting angle range from (-180 - +180) to (-90 - +90).
    
    Args:
        φ1 (float64): angle with value ranging from (-180 - +180).
        
    Returns:
        φ (float): angle with value ranging from (-90 - +90).
    """
    if 90 >= φ1 >= -90:
        φ = φ1
    elif φ1 > 90:
...
def phi_conversion360(φ1):
    """
    Converting angle range from (-180 - +180) to (0 - 360).
    
    Args:
        φ1 (float64): angle with value ranging from (-180 - +180).
        
    Returns:
        φ (float): angle with value ranging from (0 - 360).
    """
    if φ1 >= 0:
        φ = φ1
    elif φ1 < 0:
